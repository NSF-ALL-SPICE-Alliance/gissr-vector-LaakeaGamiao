...
```{r}
install.packages(c("tidyverse", "sf", "rnaturalearth", "rnaturalearthdata", "rnaturalearthhires"))
library(tidyverse)
library(sf)
...
ggplot(data = world) +
    geom_sf() +
    ggtitle("Countries of the World", subtitle = "Created by Kyle-Jacob La'akea Gamiao")
...
ggplot() + 
  geom_sf(data = world_without_antarctica, 
          fill = "#002147", color = "#CC6600", size = 0.25) +
  ggtitle("Countries of the World", subtitle = "without Antarctica")
```
...
ggplot(data = world) +
  geom_sf(fill = "#669438", color = "#32481B", size = 0.25) +
    coord_sf(crs = "+proj=ortho +lat_0=21.3193 +lon_0=157.8484 ") +
  ggtitle("Punchbowl O'ahu as the Center of the World", subtitle = "Orthographic Azimuthal")+
  theme_void()
